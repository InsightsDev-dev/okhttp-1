...
public final class StreamAllocation {
  ...
  public StreamAllocation(
      ConnectionPool connectionPool, Address address, StackTraceElement[] callStackTrace) {
  ...
  public static final class StreamAllocationReference extends WeakReference<StreamAllocation> {
     ...
     */
    public final StackTraceElement[] callStackTrace;

    StreamAllocationReference(StreamAllocation referent, StackTraceElement[] callStackTrace) {
      super(referent);
      this.callStackTrace = callStackTrace;
    }
  }
